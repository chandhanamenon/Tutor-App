...
class TutorAppDB():
    ...
    def get_all_students_for_batch_attendance(self):
        ...
        query = "SELECT  c.batch_name, b.student_name, c.batch_id FROM student_batch a, student_master b, batch_master c WHERE a.student_id=b.student_id AND a.batch_id=c.batch_id AND b.status=%s"
    ...
    def get_fee_det(self):
        ...
        query = "SELECT a.student_id, a.student_name, b.batch_name, b.fee, b.batch_id from student_master a,batch_master b,student_batch c WHERE c.batch_id=b.batch_id AND c.student_id=a.student_id AND b.status=%s"
